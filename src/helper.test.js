...
import { constrainNumber, doCirclesCollide } from "./helper.js";
...
test("do circular objects collide", () => {
  ...
  const Circles1And2 = doCirclesCollide(circle1, circle2);
  const Circles1And3 = doCirclesCollide(circle1, circle3);
  const Circles2And3 = doCirclesCollide(circle2, circle3);
